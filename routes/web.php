...
Route::get("/filiere/edit/{id}", "FilieresController@create")->name('create_filiere');
...
Route::get("/level/edit/{id}", "LevelsController@create_level")->name('create_level');
Route::patch("/level/save", "LevelsController@update")->name('update_level');

Route::resource('/matter', 'MattersController');
Route::get("/matter/edit/{id}", "MattersController@create_matter")->name('create_matter');
